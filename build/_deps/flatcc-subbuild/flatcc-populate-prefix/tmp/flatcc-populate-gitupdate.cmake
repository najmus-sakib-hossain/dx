...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v0.6.1"
  WORKING_DIRECTORY "/workspaces/dx/build/_deps/flatcc-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/dx/build/_deps/flatcc-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/dx/build/_deps/flatcc-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
