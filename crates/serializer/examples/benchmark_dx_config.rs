...
fn main() {
    ...
    for (name, bytes, chars, gpt4o, claude) in &results {
        println!("│ {name:<19} │ {bytes:>8} │ {chars:>8} │ {gpt4o:>8} │ {claude:>8} │");
    }
    println!("└─────────────────────┴──────────┴──────────┴──────────┴──────────┘\n");
    ...
    for (name, _, _, gpt4o, claude) in &results {
        ...
        println!("│ {name:<19} │ {gpt4o_savings:>14} │ {claude_savings:>14} │");
    }
    println!("└─────────────────────┴────────────────┴────────────────┘\n");
    ...
    println!("DX vs JSON:     {json_gpt4o_savings:.1}% fewer tokens (GPT-4o)");
    println!("DX vs TOON:     {toon_gpt4o_savings:.1}% fewer tokens (GPT-4o)");
    println!("DX vs YAML:     {yaml_gpt4o_savings:.1}% fewer tokens (GPT-4o)");
    println!("DX vs TOML:     {toml_gpt4o_savings:.1}% fewer tokens (GPT-4o)");
    println!();
