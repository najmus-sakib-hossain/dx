...
fn main() {
    ...
    for sr_file in &sr_files {
        ...
        println!(
            "{filename:<20} {dsr_size:>10} {machine_size:>10} {json_size:>10} {bincode_size:>10} {machine_ser_time:>10} {machine_deser_time:>10}",
        );
    }

    println!("\n=== Performance Summary ===");
    println!("Dx Serializer Format: Human-readable, token-efficient for LLMs");
    println!("Machine Format: Binary with DXMF header, native serialization");
