...
fn main() {
  ...
  2025-01-15T10:26:47Z,warn,/api/payment,429,5,Rate limit exceeded";
    ...
    println!("DX semicolon: {dx_semi_t} tokens");
    println!();
    ...
    println!("TOON:        {toon_t} tokens");
    println!("DX combined: {dx_all_t} tokens");
  ...
  ORD-004,David Wilson,david@example.com,GADGET-B:3:49.99,149.97,shipped,2025-01-12";
    ...
    println!("TOON:        {toon_o} tokens");
    println!("DX current:  {dx_curr_o} tokens");
    println!("DX optimized: {dx_opt_o} tokens");
    println!("Savings:     {savings_o:.1}%");
}
