...
pub fn count_tokens_all(text: &str) -> AllTokenCountsResult {
    ...
    AllTokenCountsResult {
        gpt4o: counts.get(&ModelType::Gpt4o).map_or(0, |i| i.count),
        claude: counts.get(&ModelType::ClaudeSonnet4).map_or(0, |i| i.count),
        gemini: counts.get(&ModelType::Gemini3).map_or(0, |i| i.count),
        other: counts.get(&ModelType::Other).map_or(0, |i| i.count),
    }
}
