...
// Allow unsafe code for performance-critical serialization operations
#![allow(unsafe_code)]
// Allow pedantic lints that are acceptable for performance-critical code
...
// Allow additional lints for tests, examples, and benchmarks
...
pub use llm::{
    ManifestEntry, SerializerManifest, SerializerOutput, SerializerOutputConfig,
    SerializerOutputError, SerializerPaths, SerializerResult,
};
