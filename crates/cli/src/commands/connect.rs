...
pub async fn run(integration: &str, token: Option<&str>) -> anyhow::Result<()> {
    println!("{} Connecting to {}...", "🔗".bright_cyan(), integration.bright_yellow());
    ...
    match integration.to_lowercase().as_str() {
        "github" => {
            if token.is_none() {
                ...
                println!("  Create one at: {}", "https://github.com/settings/tokens".bright_blue());
                println!();
                println!("  Then run: {} dx connect github --token YOUR_TOKEN", "→".bright_cyan());
                return Ok(());
            }
        ...
        "telegram" => {
            if token.is_none() {
                ...
                println!("  Create a bot via: {}", "@BotFather on Telegram".bright_blue());
                println!();
                println!("  Then run: {} dx connect telegram --token YOUR_BOT_TOKEN", "→".bright_cyan());
                return Ok(());
            }
        ...
        "discord" => {
            if token.is_none() {
                ...
                println!("  Create one at: {}", "https://discord.com/developers/applications".bright_blue());
                println!();
                println!("  Then run: {} dx connect discord --token YOUR_BOT_TOKEN", "→".bright_cyan());
                return Ok(());
            }
        ...
        "notion" => {
            if token.is_none() {
                ...
                println!("  Create one at: {}", "https://www.notion.so/my-integrations".bright_blue());
                println!();
                println!("  Then run: {} dx connect notion --token YOUR_TOKEN", "→".bright_cyan());
                return Ok(());
            }
        ...
        "slack" => {
            if token.is_none() {
                ...
                println!("  Create one at: {}", "https://api.slack.com/apps".bright_blue());
                println!();
                println!("  Then run: {} dx connect slack --token xoxb-YOUR_TOKEN", "→".bright_cyan());
                return Ok(());
            }
        ...
        "whatsapp" => {
            if token.is_none() {
                ...
                println!("  Set up at: {}", "https://developers.facebook.com/docs/whatsapp".bright_blue());
                println!();
                println!("  Then run: {} dx connect whatsapp --token YOUR_TOKEN", "→".bright_cyan());
                return Ok(());
            }
        ...
        _ => {
            ...
            println!("    {} dx create integration {} --language python", "→".bright_cyan(), integration);
        }
    }
