...
impl IntegrationManager {
    ...
    async fn load_builtin_integrations(&mut self) -> Result<()> {
        // WhatsApp
        self.integrations.insert("whatsapp".to_string(), Integration::new(IntegrationConfig {
        ...
        // Telegram
        self.integrations.insert("telegram".to_string(), Integration::new(IntegrationConfig {
            name: "telegram".to_string(),
            kind: IntegrationKind::Messaging,
            endpoint: Some("https://api.telegram.org".to_string()),
            auth_method: AuthMethod::ApiKey,
            capabilities: vec!["send_message".to_string(), "receive_message".to_string(), "send_file".to_string()],
            wasm_path: None,
            enabled: false,
        }));
        
        // Discord
        self.integrations.insert("discord".to_string(), Integration::new(IntegrationConfig {
            ...
            capabilities: vec!["send_message".to_string(), "receive_message".to_string(), "manage_channels".to_string()],
            wasm_path: None,
            enabled: false,
        }));
        
        // GitHub
        self.integrations.insert("github".to_string(), Integration::new(IntegrationConfig {
            ...
            capabilities: vec!["create_pr".to_string(), "create_issue".to_string(), "list_repos".to_string()],
            wasm_path: None,
            enabled: false,
        }));
        
        // Notion
        self.integrations.insert("notion".to_string(), Integration::new(IntegrationConfig {
            ...
            capabilities: vec!["read_page".to_string(), "write_page".to_string(), "query_database".to_string()],
            wasm_path: None,
            enabled: false,
        }));
        
        // Spotify
        self.integrations.insert("spotify".to_string(), Integration::new(IntegrationConfig {
            name: "spotify".to_string(),
            kind: IntegrationKind::Media,
            endpoint: Some("https://api.spotify.com".to_string()),
            auth_method: AuthMethod::OAuth2 {
                client_id: String::new(),
                scopes: vec!["user-read-playback-state".to_string(), "user-modify-playback-state".to_string()],
            },
            capabilities: vec!["play".to_string(), "pause".to_string(), "next".to_string(), "search".to_string()],
            wasm_path: None,
            enabled: false,
        }));
        
        // Slack
        self.integrations.insert("slack".to_string(), Integration::new(IntegrationConfig {
        ...
        // X (Twitter)
        self.integrations.insert("x".to_string(), Integration::new(IntegrationConfig {
            name: "x".to_string(),
            kind: IntegrationKind::Messaging,
            endpoint: Some("https://api.twitter.com".to_string()),
            auth_method: AuthMethod::OAuth2 {
                client_id: String::new(),
                scopes: vec!["tweet.read".to_string(), "tweet.write".to_string(), "dm.read".to_string()],
            },
            capabilities: vec!["post_tweet".to_string(), "send_dm".to_string(), "read_dm".to_string()],
            wasm_path: None,
            enabled: false,
        }));
        
        // Browser
        self.integrations.insert("browser".to_string(), Integration::new(IntegrationConfig {
            name: "browser".to_string(),
            kind: IntegrationKind::Browser,
            endpoint: None,
            auth_method: AuthMethod::None,
            capabilities: vec!["navigate".to_string(), "click".to_string(), "type".to_string(), "screenshot".to_string()],
            wasm_path: None,
            enabled: true,
        }));
        ...
        for line in content.lines() {
            ...
            if let Some((key, value)) = line.split_once('=') {
                match key.trim() {
                    ...
                    "kind" => config.kind = match value.trim() {
    ...
    pub async fn register_from_plugin(&mut self, name: &str) -> Result<()> {
        ...
        self.integrations.insert(name.to_string(), Integration::new(config));
