...
impl Skill {
    ...
    pub async fn execute(&self, context: &str) -> Result<String> {
        ...
        Ok(format!("Skill {} executed with context: {}", self.definition.name, context))
    }
...
impl SkillRegistry {
    ...
    async fn load_builtin_skills(&mut self) -> Result<()> {
        // Send Message skill
        self.skills.insert("send_message".to_string(), Skill::new(SkillDefinition {
            ...
            inputs: vec![
                SkillInput {
                    ...
                    required: true,
                    description: "The messaging platform (whatsapp, telegram, discord, etc.)".to_string(),
                },
                SkillInput {
            ...
            examples: vec![
                SkillExample {
                    input: "send_message platform=whatsapp recipient=john message=Hello!".to_string(),
                    output: "message_sent:1[platform=whatsapp recipient=john status=delivered]".to_string(),
                },
            ],
        }));
        
        // Create Todo skill
        self.skills.insert("create_todo".to_string(), Skill::new(SkillDefinition {
        ...
        // Check Email skill
        self.skills.insert("check_email".to_string(), Skill::new(SkillDefinition {
        ...
        // Browse Web skill
        self.skills.insert("browse_web".to_string(), Skill::new(SkillDefinition {
        ...
        // Run Command skill
        self.skills.insert("run_command".to_string(), Skill::new(SkillDefinition {
        ...
        // Play Music skill
        self.skills.insert("play_music".to_string(), Skill::new(SkillDefinition {
        ...
        // Create PR skill
        self.skills.insert("create_pr".to_string(), Skill::new(SkillDefinition {
    ...
    pub fn list_as_dx_llm(&self) -> String {
        let skills: Vec<String> = self.skills.values()
            .map(|s| s.to_dx_llm())
            .collect();
