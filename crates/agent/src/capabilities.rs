...
impl CapabilityRegistry {
    ...
    fn register_defaults(&mut self) {
        ...
        self.register(Capability::new("send_message", "Send messages via messaging platforms")
            .with_integration("messaging"));
        self.register(Capability::new("receive_message", "Receive messages from platforms")
            .with_integration("messaging"));
        
        // Browser capabilities
        self.register(Capability::new("browse_web", "Navigate and interact with web pages")
            .with_integration("browser"));
        self.register(Capability::new("screenshot", "Take screenshots of web pages")
            .with_integration("browser"));
        ...
        // Code generation
        self.register(Capability::new("generate_code", "Generate code in any language"));
        self.register(Capability::new("compile_wasm", "Compile code to WebAssembly"));
        
        // Integration management
        self.register(Capability::new("create_integration", "Create new integrations dynamically"));
        self.register(Capability::new("create_pr", "Create pull requests for new integrations")
    ...
    pub fn to_dx(&self) -> String {
        let caps: Vec<String> = self.capabilities.values()
