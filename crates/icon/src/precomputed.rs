...
use crate::perfect_hash::{PerfectHashIndex, LowercaseCache};
...
impl PrecomputedIndex {
    ...
    pub fn build(metadata: Vec<IconMetadata>) -> Self {
        ...
        println!("  ✓ Bloom filters: {:?}", start.elapsed());
        
        // Build prefix index
        let prefix_index = PrefixIndex::build(&lowercase_names);
        println!("  ✓ Prefix index: {:?}", start.elapsed());
        
        println!("✅ All indices built in {:?}", start.elapsed());
